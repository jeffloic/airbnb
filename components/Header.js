...
function Header() {
    ...
    return (
        ...
        <div className="flex items-center md:border-2 rounded-full py-2 md:shadow-sm">
           ...
           />
           <SearchIcon 
            className="hidden md:inline-flex h-8 bg-red-400 text-white rounded-full p-2 cursor-pointer md:mx-2 active:scale-90 transition duration-150"
           /> 
        </div>
        {/* Right */}
        ...
        {searchInput && (
                <div className="flex flex-col col-span-3 mx-auto">
                    ...
                    <div className="flex">
                        <buttom onClick={resetInput} className="flex-grow text-gray-500 cursor-pointer">Cancel</buttom>
                        <buttom className="flex-grow text-red-400 cursor-pointer">Search</buttom>
                    </div>        
                </div>
